          ...
          .patterns = (struct pattern[]){
            ...
            },
            {
              ...
              .notes = (struct note[]){
                ...
                { .time = 150, .value = 79, .duration = 10, .instrument = 0 },
              }
            },
            {
              .noteCount = 2,
              .notes = (struct note[]){
                { .time = 0, .value = 81, .duration = 20, .instrument = 0 },
            ...
            },
            {
              ...
              .notes = (struct note[]){
                { .time = 0, .value = 81, .duration = 20, .instrument = 0 },
                { .time = 80, .value = 80, .duration = 20, .instrument = 0 },
                { .time = 120, .value = 79, .duration = 10, .instrument = 0 },
              }
            },
            {
              .noteCount = 5,
              .notes = (struct note[]){
                ...
                { .time = 100, .value = 79, .duration = 30, .instrument = 0 },
